...
public class MockTestButtons {
    ...
    private void makeMockTestButtons(){
        ...
        Button topButton = createImageButton("/3FullMockColored.png", 1209, 112,11,"/3FullMockGrey.png");
        ...
        Button bottomButton = createImageButton("/3FRQMockColored.png", 1219, 116,12,"/3FRQMockGrey.png");
    ...
    private Button createImageButton(String hoverImagePath, double width, double height, int actionId, String imagePath) {
        ...
        button.setOnAction(e -> testClassInstance.setSceneForQuizzes(actionId));
